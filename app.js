...
console.log(`The ${product} in size ${selectedSize} is $${price} with ${stock} in stock.`)
...
console.log(`I am on page ${bookmark} of ${pageCount} in the book titled ${title} by ${author}.`)